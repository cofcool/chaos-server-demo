...
import net.cofcool.chaos.server.demo.api.Constants;
...
public class MyExceptionCodeDescriptor extends SimpleExceptionCodeDescriptor {
    ...
    protected Map<String, String> customize() {
        return Map.of(
            ExceptionCodeDescriptor.USER_PASSWORD_ERROR, Constants.PASSWORD_ERROR_VAL,
            ExceptionCodeDescriptor.USER_PASSWORD_ERROR_DESC, Constants.PASSWORD_ERROR_DESC_VAL
        );
    }
}
